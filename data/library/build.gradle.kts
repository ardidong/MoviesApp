...
android {
    namespace = "com.ardidong.library"
    compileSdk = 33
...
dependencies {
    ...
    implementation("${rootProject.extra["gsonConverter"]}")
    implementation("${rootProject.extra["loggingInterceptor"]}")
    implementation("${rootProject.extra["paging"]}")
